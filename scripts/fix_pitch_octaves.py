#!/usr/bin/env python3
"""Octave-error fix for an extracted melody MIDI.
...
The DEFAULT is *unguarded* (no long-char span guard): the span guard tends to
leave octave-error clusters half-corrected — the uncorrected residuals float a
full octave above the F0 contour, i.e. visible octave zigzags.  Pass ``--span-guard``
