...
held-vowel entries and merges whole sung phrases into mega-segments.  This script ignores Whisper's VAD entirely and derives segment
...
DEFAULTS = {
    ...
    # Long merged segments (close to Whisper's 30 s window) push Whisper
    # large-v3 into credits-text hallucination on dense/repetitive lyrics,
    # collapsing whole lines; 12 s keeps segments short enough to avoid it.
    "max_len": 12.0,
