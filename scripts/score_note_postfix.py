...
accompaniment chroma) — never a reference/ground-truth file.
"""
...
def refine_boundaries(
    ...
    *,
    ...
    for i in range(len(out) - 1):
        ...
        # up-to-~120ms early snap). Deliberate: karaoke-guide bars lead the
        # sung portamento, which is the convention the bar display targets.
...
def capture_tail_falls(
    ...
    *,
    ...
    aligned lyric grid does not cover (e.g. a tail mora sung F3 then Eb3).
