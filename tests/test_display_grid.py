...
def test_layout_slots_are_quantized_durations() -> None:
    # constant-speed slots: slot spacing == quantized duration exactly
...
# ---------- per-song patch application (guards against the horizontal grid
# silently dropping melisma_split / drop_notes) ----------
